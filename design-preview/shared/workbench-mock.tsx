...
export type ThemeKind = keyof typeof tokens;
export type SchemeKind = "A" | "B";
...
export const STABLE_TESTIDS: { id: string; note: string }[] = [
...
export const CHANGING_DOM: { area: string; change: string; testid: string }[] = [
...
export function WorkbenchMock({ scheme, theme }: { scheme: SchemeKind; theme: ThemeKind }) {
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          >
            <Row gap={10} align="center" style={{ height: isA ? topBarH : 28 }}>
              ...
              <span style={{ fontSize: 13, color: t.foreground, flex: 1, fontWeight: 500 }}>
                COM11 环回 · 115200 8N1
              </span>
...
export function SettingsSnippet({ theme }: { theme: ThemeKind }) {
  const t = tokens[theme];
  const rows = [
