  ...
  return (
    <ContextMenuPortal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          "z-50 max-h-[min(var(--radix-context-menu-content-available-height),24rem)] min-w-[8rem] overflow-y-auto rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-md",
          className
        )}
        {...props}
      />
